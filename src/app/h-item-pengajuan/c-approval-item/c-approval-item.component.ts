...
export class CApprovalItemComponent {
  ...
  async get_appr_subarea(){
    ...
    var xRes:any = await lastValueFrom(this.http.get(config.env_dev.host+'/api/get_appr_subarea',{params:queryParams}))
  ...
  async get_appr_person(){
    ...
    var xRes:any = await lastValueFrom(this.http.get(config.env_dev.host+'/api/get_appr_person',{params:queryParams}))
    this.lov1 = xRes.data;  
